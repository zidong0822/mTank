...
class CarViewController:UIViewController{
   ...
   // MARK: －UI控件初始化
    ...
    override func viewDidLoad() {
        ...
        shotScreenButton.addTarget(self, action:"screenShotAction:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "initbleMingle:", name: "bleMingle", object: nil)
    ...
    func createBottomButton(){
        ...
        controlButton.addTarget(self, action:"controlAction:", forControlEvents: UIControlEvents.TouchUpInside)
...
extension CarViewController{
    ...
    func doTimer(){
        ...
        writeDataTimer = NSTimer.scheduledTimerWithTimeInterval(0.020, target: self, selector: "timerFireMethod", userInfo: nil, repeats:true);
        writeDataTimer.fire()
...
extension CarViewController{
    ...
    func controlAction(sender:UIButton){
        ...
        controlViewController.view.frame = CGRectMake(0, 0,270,SCREEN_HEIGHT)
        self.presentViewController(ControlViewController(), animated:true) { () -> Void in
